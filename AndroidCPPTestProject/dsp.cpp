//#pragma once
#include "pch.h"
#include "dsp.h" // Replace with the actual header file name
#include <stdio.h>
#include <math.h>
#include <cmath>

static void fft_complex(double* real, double* imag, int size, int direction = 1, bool reorder = true, bool scaleForwardTransform = true) {
    ...
    for (int LevelSize = 1; LevelSize < size; LevelSize *= 2) {
        ...
        for (int k = 0; k < LevelSize; ++k) {
            ...
            double wX = std::cos(exponent);  // N.B. this step of the algorithm suffers from the inexact floating point numbers returned from the trigonometric functions cos and sin
            double wY = std::sin(exponent);
