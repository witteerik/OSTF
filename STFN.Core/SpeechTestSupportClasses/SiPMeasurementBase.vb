...
Namespace SipTest
    ...
    Public Class SipMeasurementBase
        ...
        Public Sub New(ByRef ParticipantID As String, ByRef ParentTestSpecification As SpeechMaterialSpecification, Optional AdaptiveType As AdaptiveTypes = AdaptiveTypes.Fixed, Optional ByVal TestParadigm As SiPTestparadigm = SiPTestparadigm.Slow, Optional RandomSeed As Integer? = Nothing)
        ...
        Private Class TestTrialSoundMixerOnNewThread
            ...
            Public SipMeasurement As SipMeasurementBase
            ...
            Public Sub New(ByRef SipMeasurement As SipMeasurementBase, ByRef SelectedTransducer As AudioSystemSpecification,
                                         ByVal MinimumStimulusOnsetTime As Double, ByVal MaximumStimulusOnsetTime As Double,
                                         ByRef SipMeasurementRandomizer As Random, ByVal TrialSoundMaxDuration As Double, ByVal UseBackgroundSpeech As Boolean,
