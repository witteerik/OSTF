...
Namespace SipTest
    ...
    Public Class SipMeasurement
        Inherits SipMeasurementBase





        Public Sub New(ByRef ParticipantID As String, ByRef ParentTestSpecification As SpeechMaterialSpecification, Optional AdaptiveType As AdaptiveTypes = AdaptiveTypes.Fixed,
                       Optional ByVal TestParadigm As SiPTestparadigm = SiPTestparadigm.Slow, Optional RandomSeed As Integer? = Nothing)
