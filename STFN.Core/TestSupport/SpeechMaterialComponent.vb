...
Public Class SpeechMaterialComponent
    ...
    Public Shared ImageLibrary As New SortedList(Of String, String) ' System.Drawing.Bitmap in .NET Framework. TODO: Since bitmap is removed in NET7, we'll have to find a better alternative here. For now, we just put in the image file path.
    ...
    Public Function GetImage(ByVal Path) As String 'Drawing.Bitmap
