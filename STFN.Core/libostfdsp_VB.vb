...
Public Class LibOstfDsp_VB
    ...
    Public Shared Sub CopyToDouble(SourceArray As Single(), TargetArray As Double())
        ...
        Select Case OstfBase.CurrentPlatForm
            ...
            Case Else
                Throw New NotImplementedException("Optimization library not implemented for the " & OstfBase.CurrentPlatForm.ToString & " platform.")
    ...
    Public Shared Sub Fft_complex(real As Double(), imag As Double(), size As Integer, Optional Direction As Audio.DSP.FftDirections = Audio.DSP.FftDirections.Forward, Optional reorder As Boolean = True, Optional scaleForwardTransform As Boolean = True)
        ...
        Select Case OstfBase.CurrentPlatForm
            ...
            Case Else
                Throw New NotImplementedException("Optimization library FFT is not implemented for the " & OstfBase.CurrentPlatForm.ToString & " platform.")
        End Select
