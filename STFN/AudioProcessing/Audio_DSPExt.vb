        ...
        Public Module MeasurementsExt
            ...
            Public Function MeasureGatedSectionLevel(ByVal InputSound As Sound, ByVal channel As Integer,
                ...
                Try
                    ...
                    Dim windowCount As Integer = STFN.Core.Utils.Rounding((sectionLength / windowLength), STFN.Core.Utils.roundingMethods.alwaysDown)
            ...
            Public Function MeasureTimeAndFrequencyWeightedSectionLevel(ByVal InputSound As Sound, ByVal Channel As Integer,
                ...
                Try
                    ...
                    Dim FullWindowCount As Integer = STFN.Core.Utils.Rounding((SectionLength / fullWindowLength), STFN.Core.Utils.roundingMethods.alwaysUp)
        ...
        Public Module AcousticDistance
          ...
          Math.Min(Sound1.WaveData.ShortestChannelSampleCount, Sound2.WaveData.ShortestChannelSampleCount)
            ...
            Private Function CalculateTimeWarpedAcousticDistance(ByRef FftData1 As FftData,
                ...
                If ExportDetails = True And MatrixOutputFolder <> "" Then
                    ...
                    For p = 0 To CentreFrequencies.Count - 1
                        ...
                        newDoubleArray(1, p) = STFN.Core.Utils.CenterFrequencyToBarkFilterBandwidth(CentreFrequencies(p))
                    Next
            ...
            Private Function IsBelowBlockingAreaBoundary(ByRef Capital_I As Integer, ByRef i As Integer,
                ...
                If j > STFN.Core.Utils.Rounding(((Capital_J * i) / (2 * Capital_I)) + (Capital_J / 2), STFN.Core.Utils.roundingMethods.alwaysUp) Then Return False
            ...
            Private Function IsRightOfBlockingAreaBoundary(ByRef Capital_I As Integer, ByRef i As Integer,
                ...
                If i > STFN.Core.Utils.Rounding(((Capital_I * j) / (2 * Capital_J)) + (Capital_I / 2), STFN.Core.Utils.roundingMethods.alwaysUp) Then Return False
                    ...
                    If CentreFrequencies Is Nothing Then
                        ...
                        If CentreFrequencies Is Nothing Then 'Line added 2018-04-13. Speeds up processing by re-using the object. Should makes no difference, as long as CentreFrequencies is not modified externally.
                            ...
                            Do
                                ...
                                Dim CurrentBandWidth As Single = STFN.Core.Utils.CenterFrequencyToBarkFilterBandwidth(CurrentCentreFrequency)
                    ...
                    For w = 0 To FftData.WindowCount(1) - 1
                        ...
                        For CentreFrequencyIndex = 0 To CentreFrequencies.Count - 1
                            ...
                            Dim LowestIncludedBinIndex As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex,
                                                                        LowerFrequencyLimit, SampleRate, FftData.FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysDown)
                            Dim HighestIncludedBinIndex As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex,
                                                                        HighestFrequencyLimit, SampleRate, FftData.FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysUp)
                            Dim CentreBinIndex As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex,
                                                                        CurrentCentreFrequency, SampleRate, FftData.FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.getClosestValue)
        ...
        Public Module TransformationsExt
            ...
            Public Function GetSoundLevelVariation(ByRef InputSound As Sound, ByRef SectionLength As Integer, ByRef MeasurementChannel As Integer,
                ...
                Try
                    ...
                    Dim CV As Double = STFN.Core.Utils.CoefficientOfVariation(SoundLevelList,,,,, StandardDeviation)
                    ...
                    Select Case inputSound.WaveFormat.BitDepth
                        Case 16, 32
                            For c = AudioOutputConstructor.FirstChannelIndex To AudioOutputConstructor.LastChannelIndex
                                ...
                                STFN.Core.Utils.CopyToDouble(TempArray, IRArray)
                                ...
                                If ScaleImpulseResponse = True Then
                                    ...
                                    If ImpulseResponseArraySum <> 0 Then
                                        STFN.Core.Utils.MultiplyArray(IRArray, (1 / ImpulseResponseArraySum))
                                    Else
                ...
                Try
                    ...
                    For c = AudioOutputConstructor.FirstChannelIndex To AudioOutputConstructor.LastChannelIndex
                        ...
                        If LowerCutoffFrequency IsNot Nothing Then
                            ...
                            PositiveSide_LowerInclusiveCutoffIndex = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, LowerCutoffFrequency, InputSound.WaveFormat.SampleRate, FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysUp)
                        ...
                        If UpperCutoffFrequency IsNot Nothing Then
                            ...
                            PositiveSide_UpperInclusiveCutoffIndex = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, UpperCutoffFrequency, InputSound.WaveFormat.SampleRate, FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysDown)
                ...
                Try
                    ...
                    For c = AudioOutputConstructor.FirstChannelIndex To AudioOutputConstructor.LastChannelIndex
                        ...
                        If LowerCutoffFrequency IsNot Nothing Then
                            ...
                            Dim LowerInclusiveCutoffIndex As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, LowerCutoffFrequency, InputSound.WaveFormat.SampleRate, FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysUp)
                        ...
                        If UpperCutoffFrequency IsNot Nothing Then
                            ...
                            Dim UpperInclusiveCutoffIndex As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, UpperCutoffFrequency, InputSound.WaveFormat.SampleRate, FftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysDown)
                        ...
                        Case 16, 32
                            For c = AudioOutputConstructor.FirstChannelIndex To AudioOutputConstructor.LastChannelIndex
                                ...
                                For windowNumber = 0 To numberOfWindows - 2 'Step 2
                                    ...
                                    If LowerCutoffFrequency IsNot Nothing Then
                                        StartIndex = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, LowerCutoffFrequency, inputSound.WaveFormat.SampleRate, fftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysUp)
                                    End If

                                    If UpperCutoffFrequency IsNot Nothing Then
                                        EndIndex = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex, UpperCutoffFrequency, inputSound.WaveFormat.SampleRate, fftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysDown)
                                    End If
                ...
                Try
                    ...
                    For Each SoundSection In SoundList
                        ...
                        If MinimumIncludedMaxLevel_dBSPL IsNot Nothing Then
                            ...
                            If dBSPL_dBFS_Difference Is Nothing Then dBSPL_dBFS_Difference = STFN.Core.Audio.Standard_dBFS_dBSPL_Difference
        ...
        Public Class GammatoneFirFilterBank
            ...
            Public Function CreateGammatoneImpulseResponse(ByRef format As Formats.WaveFormat,
                ...
                Try
                    ...
                    Dim ProbeSignal = STFN.Core.Audio.GenerateSound.CreateSineWave(format,, CentreFrequency, PrePeaklevel, SoundDataUnit.dB, 10)
                    ...
                    If ZeroPhaseKernel = True Then
                        ...
                        outputSound = STFN.Core.Audio.GenerateSound.GetImpulseResponseFromSound(outputSound, FftFormat2,
                                                                    FftFormat2.FftWindowSize,,,, True, True)
                    End If

                    'Repeating one more time for increased accuracy (avoiding rounding errors)

                    Dim ProbeSignal_B = STFN.Core.Audio.GenerateSound.CreateSineWave(format,, CentreFrequency, PrePeaklevel, SoundDataUnit.dB, 10)
        ...
        Public Module SignalsExt
            ...
            Public Function CreateFrequencyModulatedSound(ByVal ModulationSound As Sound, Optional ByVal channel As Integer? = Nothing,
                ...
                Try
                    ...
                    Dim outputSound = STFN.Core.Audio.GenerateSound.CreateSineWave(ModulationSound.WaveFormat, , CarrierFrequency, CarrierIntensity, intensityUnit, ModulationSound.WaveData.SampleData(1).Length, TimeUnits.samples)
            ...
            Public Function CreatePeriodicRandomNoise(ByRef format As Formats.WaveFormat, Optional ByVal channel As Integer? = Nothing,
                ...
                Try
                    ...
                    Dim NumberOfPeriods As Integer = STFN.Core.Utils.Rounding(dataLength / PeriodLength, STFN.Core.Utils.roundingMethods.alwaysUp)
                ...
                For c = AudioOutputConstructor.FirstChannelIndex To AudioOutputConstructor.LastChannelIndex
                    ...
                    If LowerCutoffFrequency.HasValue Then
                        ...
                        Dim LowerCutoffBin As Integer = FftBinFrequencyConversion(FftBinFrequencyConversionDirection.FrequencyToBinIndex,
                                                                              ...
                                                                              fftFormat.FftWindowSize, STFN.Core.Utils.roundingMethods.alwaysDown)
            ...
            Public Function GetImpulseResponseForFrequencyResponseFlattening(ByRef InputSound As Sound,
                ...
                Dim FlatSpectrumSound = STFN.Core.Audio.GenerateSound.CreateSilence(InputSound.WaveFormat,  , InputSound.WaveData.LongestChannelSampleCount, TimeUnits.samples)
            ...
            Public Function GetIrArrayFromSound(ByRef InputSound As Sound,
                ...
                Try
                    ...
                    For w = 0 To WindowCount - 1
                        ...
                        Dim IR As Sound = STFN.Core.Audio.GenerateSound.GetImpulseResponseFromSound(WindowSound, FftFormat, KernelSize, Channel)
            ...
            Public Function CreateIrArrayFilteredNoise(ByRef IrArray() As Sound,
                ...
                For w = 0 To IrArray.Length - 1
                    ...
                    'Creating a noise
                    Dim CurrentNoise As Sound = STFN.Core.Audio.GenerateSound.CreateWhiteNoise(TempWaveFormat,, 0.1, SectionLengths, TimeUnits.samples, RandomSource)
            ...
            Public Function GetSpectrallyModulatedNoiseFromFile(ByVal InputSound As Sound,
                ...
                Dim Ir = STFN.Core.Audio.GenerateSound.GetImpulseResponseFromSound(InputSound, FftFormat, KernelSize)

                'Creating a noise
                Dim Output As Sound = STFN.Core.Audio.GenerateSound.CreateWhiteNoise(InputSound.WaveFormat,, 0.1, InputSound.WaveData.ShortestChannelSampleCount + CrossFadeLength, TimeUnits.samples)
                ...
                Try
                    ...
                    For n = 0 To NumberOfOverlays - 1
                        ...
                        For Each Sound In SoundsInOrderToUse
                            ...
                            SoundsToConcatenate.Add(STFN.Core.Audio.GenerateSound.CreateSilence(WaveFormat,, Rnd.Next(MinInterval, MaxInterval + 1) / 1000))
