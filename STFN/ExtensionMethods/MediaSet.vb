...
#Region "Variation preserving sound level normalization"
    ...
    Public Sub CalculateAverageMaxLevelOfCousinComponents(obj As STFN.Core.MediaSet, ByVal SummaryLevel As SpeechMaterialComponent.LinguisticLevels,
                                                               ...
                                                               Optional ByVal FrequencyWeighting As STFN.Core.Audio.FrequencyWeightings = STFN.Core.Audio.FrequencyWeightings.Z,
    ...
    Public Function GetSoundLevelOfConcatenatedSounds(ByVal InputSounds As List(Of STFN.Core.Audio.Sound),
                                                                  ByVal FrequencyWeighting As STFN.Core.Audio.FrequencyWeightings,
...
#End Region
    ...
    <Extension>
    Public Sub SetSpeechLevels(obj As STFN.Core.MediaSet, ByVal TargetLevel As Double, ByVal FrequencyWeighting As STFN.Core.Audio.FrequencyWeightings, ByVal TemporalIntegration As Double?, ByVal LinguisticLevel As SpeechMaterialComponent.LinguisticLevels)
