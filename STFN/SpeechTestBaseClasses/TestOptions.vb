...
'        End Get
'        Set(value As Double)
'            _ReferenceLevel = Math.Round(Math.Round(value / SelectedTest.ReferenceLevel_StepSize) * SelectedTest.ReferenceLevel_StepSize)
...
'                    If TO_UseRetsplCorrection = True Then
...
'        End Get
'        Set(value As Double)
'            _SpeechLevel = Math.Round(Math.Round(value / SelectedTest.TargetLevel_StepSize) * SelectedTest.TargetLevel_StepSize)
...
'        End Get
'        Set(value As Double)
'            _MaskingLevel = Math.Round(Math.Round(value / SelectedTest.MaskingLevel_StepSize) * SelectedTest.MaskingLevel_StepSize)
...
'        End Get
'        Set(value As Double)
'            _BackgroundLevel = Math.Round(Math.Round(value / SelectedTest.BackgroundLevel_StepSize) * SelectedTest.BackgroundLevel_StepSize)
...
'        End Get
'        Set(value As Double)
'            _ContralateralMaskingLevel = Math.Round(Math.Round(value / SelectedTest.ContralateralMaskingLevel_StepSize) * SelectedTest.ContralateralMaskingLevel_StepSize)
...
'    ''' </summary>
'    ''' <returns></returns>
'    Public Property TO_UseRetsplCorrection As Boolean
'        Get
'            Return _TO_UseRetsplCorrection
'        End Get
'        Set(value As Boolean)
'            _TO_UseRetsplCorrection = value
...
'        End Set
'    End Property
'    Private _TO_UseRetsplCorrection As Boolean = False
...
'    ''' </summary>
'    ''' <returns></returns>
'    Public Property TO_UseContralateralMasking As Boolean
'        Get
'            Return _TO_UseContralateralMasking
'        End Get
'        Set(value As Boolean)
'            _TO_UseContralateralMasking = value
'            OnPropertyChanged()
'        End Set
'    End Property
'    Private _TO_UseContralateralMasking As Boolean = False
...
'        If TO_UseContralateralMasking = True Then
...
'    ''' </summary>
'    ''' <returns></returns>
'    Public Property TO_UsePhaseAudiometry As Boolean
'        Get
'            Return _TO_UsePhaseAudiometry
'        End Get
'        Set(value As Boolean)
'            _TO_UsePhaseAudiometry = value
'            OnPropertyChanged()
'        End Set
'    End Property
'    Private _TO_UsePhaseAudiometry As Boolean = False
