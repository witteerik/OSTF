            ...
            Try
                ...
                For TargetIndex = 0 To NumberOfTargets - 1
                    ...
                    Else
                        ...
                        'Adds the component, plus if present the catch component, in the order specified in RandomWordPresentationOrderList
                        'Not that the catch component should have an index higher that the number of test components -1
