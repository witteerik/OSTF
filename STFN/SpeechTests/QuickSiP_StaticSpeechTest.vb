    ...
    Public Overrides Function GetSpeechTestReply(sender As Object, e As SpeechTestInputEventArgs) As SpeechTestReplies
        ...
        If ProtocolReply.Decision = SpeechTestReplies.GotoNextTrial Then
            ...
            If ObservedTrials.Count = 0 Then
                ...
                Dim InitialSound = STFN.Audio.Sound.LoadWaveFile(InitialSoundPath)
                ...
                Dim TrialSound = STFN.Audio.Sound.LoadWaveFile(TrialSoundFilePath)
            ...
            Else
                ...
                CurrentTestTrial.Sound = STFN.Audio.Sound.LoadWaveFile(SoundFilePath)
