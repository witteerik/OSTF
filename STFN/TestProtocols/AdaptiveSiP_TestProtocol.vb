...
Public Class AdaptiveSiP_TestProtocol
    Inherits TestProtocol

    Public Overrides ReadOnly Property Name As String
        Get
            Return "Adaptive SiP protocol"
        End Get
    End Property

    Public Overrides ReadOnly Property Information As String
        Get
            Return "This is a modification of the Brand-Kollmeier (2002) protocol"
        End Get
    End Property
    ...
    Public Overrides Function NewResponse(ByRef TrialHistory As TestTrialCollection) As NextTaskInstruction
        ...
        'Scaling DeltaL for 15 instead of 5 presentations in the Adaptive SiP
        DeltaL *= 3
