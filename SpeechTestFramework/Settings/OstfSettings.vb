Public Class OstfSettings
    ...
    ' Program location
    Public Shared Property RootPath As String = "C:\OSTA\Tests" 'Indicates the root path. Other paths given in the project setting files are relative (subpaths) to this path only if they begin with .\ otherwise they are taken as absolute paths.
