    ...
    Private Sub DirectionalSimulationSet_ComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DirectionalSimulationSet_ComboBox.SelectedIndexChanged
        ...
        If SelectedItem IsNot Nothing Then
            ...
            Else
                ...
                If DirectionalSimulator.TrySetSelectedDirectionalSimulationSet(SelectedItem, SelectedTransducer, TempWaveformat.SampleRate, True) = False Then
    ...
    Private Shared Function PlanBinauralTrials(ByRef SipTestMeasurement As SipMeasurement, ByVal ReferenceLevel As Double, ByVal PresetName As String,
        ...
        For Each BlockType In BlockTypes
            ...
            If CurrentBlockIsBMLD = False Then
                ...
                TargetStimulusLocations = {New SoundSourceLocation With {.HorizontalAzimuth = SignalLocation, .Elevation = 0, .Distance = SelectedSimulationDistance}}
                MaskerLocations = {New SoundSourceLocation With {.HorizontalAzimuth = MaskerLocation, .Elevation = 0, .Distance = SelectedSimulationDistance}}

                'Adding a number of background sounds
                BackgroundLocations = {
                    New SoundSourceLocation With {.HorizontalAzimuth = 60, .Elevation = 0, .Distance = SelectedSimulationDistance},
                    New SoundSourceLocation With {.HorizontalAzimuth = 150, .Elevation = 0, .Distance = SelectedSimulationDistance},
                    New SoundSourceLocation With {.HorizontalAzimuth = -150, .Elevation = 0, .Distance = SelectedSimulationDistance},
                    New SoundSourceLocation With {.HorizontalAzimuth = -60, .Elevation = 0, .Distance = SelectedSimulationDistance}}
