...
Public Module ImpulseResponseCustomFunctions
    ...
    Public Sub MeasureIrGain(ByVal IrPath As String, ByVal OutputFolder As String)
        ...
        Dim BandPassIr = Audio.GenerateSound.CreateSpecialTypeImpulseResponse(Ir.WaveFormat, New Formats.FftFormat(), 8192, 1, FilterType.BandPass, 200, 8000, -100, 0, 18)

        'Bandbass-filter noise
        Dim BandPassNoise = Audio.DSP.FIRFilter(WhiteNoise, BandPassIr, New Formats.FftFormat,,,,,,, True)
        ...
        Dim FilteredNoise = Audio.DSP.FIRFilter(BandPassNoise, Ir, New Formats.FftFormat,,,,,,, True)
